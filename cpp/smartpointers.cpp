...
{
{
unique_ptr<Ptr> p(new Ptr());   // constructor of unique pointer needs to called explicitly p=new Ptr() is not allowed
...
p->Print();   //arrow operator is used to access the member functions of the class using the pointer
}
